...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(t,e.get(A)),function i(e){var t=e.get(l),n=e.get(r.NgZone);t.attachToZone(n);var o=e.get(L);n.runGuarded((function(){o.forEach((function(e){e.start()}))}))}(e)}},multi:!0,deps:[r.Injector]},{provide:r.PLATFORM_ID,useValue:t.ɵPLATFORM_WORKER_UI_ID},{provide:l,useFactory:function D(e){return e.bus},deps:[A]}],j=r.createPlatformFactory(r.platformCore,"workerUi",T),x=new r.Version("10.0.0-rc.0+168.sha-62e4acc"),V=function(){function e(e,t,r,n){this._brokerFactory=e,this._platformLocation=t,this._serializer=n,this._platformLocation.onPopState(this._sendUrlChangeEvent.bind(this)),this._platformLocation.onHashChange(this._sendUrlChangeEvent.bind(this)),this._broker=this._brokerFactory.createMessageBroker("ng-Router"),this._channelSink=r.to("ng-Router")}return e.prototype.start=function(){this._broker.registerMethod("getLocation",null,this._getLocation.bind(this),p),this._broker.registerMethod("setPathname",[1],this._setPathname.bind(this)),this._broker.registerMethod("pushState",[1,1,1],this._platformLocation.pushState.bind(this._platformLocation)),this._broker.registerMethod("replaceState",[1,1,1],this._platformLocation.replaceState.bind(this._platformLocation)),this._broker.registerMethod("forward",null,this._platformLocation.forward.bind(this._platformLocation)),this._broker.registerMethod("back",null,this._platformLocation.back.bind(this._platformLocation))},e.prototype._getLocation=function(){return Promise.resolve(this._platformLocation.location)},e.prototype._sendUrlChangeEvent=function(e){this._channelSink.emit({event:{type:e.type},location:this._serializer.serialize(this._platformLocation.location,p)})},e.prototype._setPathname=function(e){this._platformLocation.pathname=e},e.decorators=[{type:r.Injectable}],e.ctorParameters=function(){return[{type:b},{type:t.ɵBrowserPlatformLocation},{type:l},{type:h}]},e}(),Z=[{provide:V,deps:[b,t.ɵBrowserPlatformLocation,l,h]},{provide:t.ɵBrowserPlatformLocation,deps:[t.DOCUMENT]},{provide:r.PLATFORM_INITIALIZER,useFactory:function G(e){return function(){e.get(r.NgZone).runGuarded((function(){return e.get(V).start()}))}}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function Y(e){return e.initialized}function X(e,t){return function(){return t.runGuarded((function(){return e.init()}))}}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.ClientMessageBroker=f,e.ClientMessageBrokerFactory=d,e.FnArg=y,e.MessageBus=l,e.ServiceMessageBroker=k,e.ServiceMessageBrokerFactory=b,e.UiArguments=_,e.VERSION=x,e.WORKER_APP_LOCATION_PROVIDERS=K,e.WORKER_UI_LOCATION_PROVIDERS=Z,e.WorkerAppModule=se,e.bootstrapWorkerUi=function ae(e,t){void 0===t&&(t=[]);var r=j(a([{provide:z,useValue:e}],t));return Promise.resolve(r)},e.platformWorkerApp=te,e.platformWorkerUi=j,e.ɵangular_packages_platform_webworker_platform_webworker_a=h,e.ɵangular_packages_platform_webworker_platform_webworker_b=Y,e.ɵangular_packages_platform_webworker_platform_webworker_c=X,e.ɵangular_packages_platform_webworker_platform_webworker_d=re,e.ɵangular_packages_platform_webworker_platform_webworker_e=oe,e.ɵangular_packages_platform_webworker_platform_webworker_f=ie,e.ɵangular_packages_platform_webworker_platform_webworker_g=T,e.ɵangular_packages_platform_webworker_platform_webworker_h=u,e.ɵangular_packages_platform_webworker_platform_webworker_i=H,e.ɵangular_packages_platform_webworker_platform_webworker_j=J,e.ɵangular_packages_platform_webworker_platform_webworker_k=c,Object.defineProperty(e,"__esModule",{value:!0})}));