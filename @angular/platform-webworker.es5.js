...
MessageBasedRenderer.ctorParameters = function () {
    return [{ type: ServiceMessageBrokerFactory }, { type: MessageBus }, { type: Serializer }, { type: RenderStore }, { type: RootRenderer }];
};
...
var /** @type {?} */_WORKER_UI_PLATFORM_PROVIDERS = [{ provide: NgZone, useFactory: createNgZone, deps: [] }, MessageBasedRenderer, { provide: WORKER_UI_STARTABLE_MESSAGING_SERVICE, useExisting: MessageBasedRenderer, multi: true }, ɵBROWSER_SANITIZATION_PROVIDERS, { provide: ErrorHandler, useFactory: _exceptionHandler, deps: [] }, { provide: DOCUMENT, useFactory: _document, deps: [] },
    ...
    _createClass(WebWorkerRootRenderer, [{
        ...
        value: function renderComponent(componentType) {
            ...
            if (!result) {
                ...
                this.runOnService('renderComponent', [new FnArg(componentType, RenderComponentType), new FnArg(result, 2 /* RENDER_STORE_OBJECT */)]);
            }
            return result;
        }
        /**
...
var WebWorkerRenderer = function () {
    ...
    _createClass(WebWorkerRenderer, [{
        ...
        value: function createViewRoot(hostElement) {
            var /** @type {?} */viewRoot = this._componentType.encapsulation === ViewEncapsulation.Native ? this._rootRenderer.allocateNode() : hostElement;
